...
namespace EngineeringMath.Model
{
    public class EngineeringMathSeedData
    {
        ...
        public Dictionary<string, FunctionCategory> FunctionCategories { get; }
        public Dictionary<string, Owner> Owners { get; }
        public Dictionary<string, ParameterType> ParameterTypes { get; }
        public Dictionary<string, UnitCategory> UnitCategories { get; }
        public Dictionary<string, UnitSystem> UnitSystems { get; }
        public EngineeringMathSeedData()
        {
            ...
            var unitCaegories = new List<UnitCategory>
                {
                    area, density, energy,
